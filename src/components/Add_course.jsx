...
function Add_course() {
 ...
 function All(){
  ...
  function Coursesbox() {
    ...
    let setTitle= useSetRecoilState(titleState)
    let Title = useRecoilValue(titleState)

    let setPrice= useSetRecoilState(priceState)
    let Price = useRecoilValue(priceState)
   
    let setImg= useSetRecoilState(imgState)
    let Img = useRecoilValue(imgState)
   ...
   "data:image/jpeg;base64,"]
    ...
    return (
        <>
         <div style ={{ width : 600,paddingRight:0 , marginTop : 100, marginLeft : 500 ,
           flexWrap : 'wrap' , justifyContent : "center",textAlign: "center"}}>
      <Container disableGutters sx={{   border:2 ,px : 0 ,py : 0 , m :0, width : 605}}  >
    ...
    <TextField fullWidth id="Password" label="Price" variant="filled"  
    onChange={(e)=>{ setPrice(e.target.value)
      }}/>
    <br/><br/>

    <TextField fullWidth id="Password" label="Image" variant="filled"  
    ...
    <Button variant="contained" sx={{m:1 }} 
      onClick={()=>{
          ...
          description : Description ,Image : Img == null || ' ' ? Imga[Math.floor(Math.random() *3)] : Img ,
           price : Price  ? Price  : 'Not Published'  }), headers : {'Content-Type' : 'application/json' , 
    ...
    <br/>
      ...
      <div style={{width : 500 , background :'Yellow', marginLeft:0 , textAlign : "left"}}>
     {x}
     </div>
